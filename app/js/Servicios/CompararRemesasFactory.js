...
.factory('CompararRemesasFactory', function($q, $http, ConexionServ, rutaServidor) {

                
    result = {
        
        traer: function(distrito_id, codigo_cuenta, years, is_online){ 
            var defered     = $q.defer();
            var resp        = {};
            ...
            if (is_online) {
                ...
                datos = { distrito_id: distrito_id, codigo_cuenta: codigo_cuenta, years: years };
                
                $http.put(rutaServidor.root + '/au_comparar/iglesias-meses-year', datos).then(function(r){
                    r = r.data;
                    resp.iglesias = r.iglesias;
